...
2. Инструкция по установке [Установка CherryLink](https://seocherry.ru/dev/install-cherrylink/ "Если возникнут сложности")
3. Подробный мануал по использованию [Руководство пользователя](https://seocherry.ru/dev/cherrylink-manual/ "Есть ответы на многие вопросы")
...
Чат в телеграме [Техподдержка](https://t.me/seovishnya "Обсуждение работы плагинов") и мой контакт [@anton_seocherry](https://t.me/anton_seocherry "Телега")
...
Автоматическое создание индекса страниц происходит при установке только в том случае, если на сайте не больше 200 записей. В противном случае вы увидите увдомление о просьбе создать индекс самостоятельно.
