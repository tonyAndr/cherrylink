...
function linkate_sp_prepare_suggestions($title, $seotitle,$min_len, $suggestions_donors, $linkate_overusedwords, $clean_suggestions_stoplist, $stemmer) {
	$title = trim($title);
	...
	if ($suggestions_donors == 'intersection') {
